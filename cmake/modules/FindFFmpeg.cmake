# * Try to find ffmpeg libraries (libavcodec, libavformat, libavutil,
#   libswscale) Once done this will define
#
# FFMPEG_FOUND - system has ffmpeg or libav FFMPEG_INCLUDE_DIR - the ffmpeg
# include directory FFMPEG_LIBRARIES - Link these to use ffmpeg
#
...
if(FFMPEG_LIBRARIES AND FFMPEG_INCLUDE_DIR)
  ...
  if(FFMPEG_FOUND)
    ...
    set(FFMPEG_LIBRARIES
        ${FFMPEG_LIBAVCODEC} ${FFMPEG_LIBAVFORMAT} ${FFMPEG_LIBAVUTIL}
    ...
    if(FFMPEG_FIND_REQUIRED)
      message(
        FATAL_ERROR "Could not find libavcodec or libavformat or libavutil")
