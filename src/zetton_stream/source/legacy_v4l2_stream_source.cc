...
LegacyV4l2StreamSource::LegacyV4l2StreamSource()
    : fd_(-1),
      buffers_(nullptr),
      n_buffers_(0),
      is_capturing_(false),
...
LegacyV4l2StreamSource::~LegacyV4l2StreamSource() { shutdown(); }

bool LegacyV4l2StreamSource::Init(const StreamOptions& options) {
  options_ = options;
  monochrome_ = false;
...
bool LegacyV4l2StreamSource::Capture(const CameraImagePtr& raw_image) {
  raw_image->is_new = 0;
...
bool LegacyV4l2StreamSource::open_device() {
  struct stat st;
...
bool LegacyV4l2StreamSource::init_device() {
...
bool LegacyV4l2StreamSource::init_read(unsigned int buffer_size) {
...
bool LegacyV4l2StreamSource::init_mmap() {
...
bool LegacyV4l2StreamSource::init_userp(unsigned int buffer_size) {
  struct v4l2_requestbuffers req;
...
bool LegacyV4l2StreamSource::start_capturing() {
  if (is_capturing_) {
    return true;
  }
...
void LegacyV4l2StreamSource::set_device_config() {
...
bool LegacyV4l2StreamSource::uninit_device() {
  unsigned int i = 0;
...
bool LegacyV4l2StreamSource::close_device() {
  if (-1 == close(fd_)) {
    AERROR << "close";
    return false;
  }
...
bool LegacyV4l2StreamSource::stop_capturing() {
  if (!is_capturing_) {
    return true;
  }
...
bool LegacyV4l2StreamSource::read_frame(CameraImagePtr raw_image) {
  struct v4l2_buffer buf;
  unsigned int i = 0;
  int len = 0;
...
bool LegacyV4l2StreamSource::process_image(void* src, int len,
                                           CameraImagePtr dest) {
...
bool LegacyV4l2StreamSource::IsCapturing() { return is_capturing_; }

// enables/disables auto focus
void LegacyV4l2StreamSource::set_auto_focus(int value) {
 ...
 */
void LegacyV4l2StreamSource::set_v4l_parameter(const std::string& param,
                                               int value) {
...
bool LegacyV4l2StreamSource::WaitForDevice() {
  if (is_capturing_) {
    ADEBUG << "is capturing";
    return true;
  }
...
void LegacyV4l2StreamSource::reconnect() {
  stop_capturing();
  uninit_device();
  close_device();
}

void LegacyV4l2StreamSource::shutdown() {
  stop_capturing();
  uninit_device();
  close_device();
}
